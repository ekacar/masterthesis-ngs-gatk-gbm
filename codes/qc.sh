...
#Use Fastqc to check the quality of individual bam files
...
#Use mosdepth, we need to index our bam files
for sample in "${samples[@]}"; do
 gatk BuildBamIndex \
...
#Calculate the coverage in case of WES of genomic regions 
for sample in "${samples[@]}"; do
